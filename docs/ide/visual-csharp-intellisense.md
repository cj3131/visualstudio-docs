...
---
# Visual C# IntelliSense
Visual C# IntelliSense is available when coding in the editor, and while you are debugging in the [Immediate Mode](../ide/reference/immediate-window.md) command window.  
